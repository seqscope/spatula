...
int32_t main(int32_t argc, char **argv)
{
  ...
  LONG_COMMAND_GROUP("FICTURE Tools", NULL)
  ...
  LONG_COMMAND_GROUP("Image Tools", NULL)
  ...
  if (argc < 2)
  {
    printf("[spatula %s] -- spatial transcriptomics utilities\n\n", SPATULA_VERSION_STRING);
